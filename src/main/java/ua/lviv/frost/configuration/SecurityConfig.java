...
import ua.lviv.frost.security.CustomUserDetailsService;
import ua.lviv.frost.security.JwtAuthenticationEntryPoint;
import ua.lviv.frost.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTH_WHITELIST = {
            ...
            "/h2/**",
            "/api/auth/**",
            "/api/present/box/listAll",
            "/api/present/box/getOne/**"
    };
