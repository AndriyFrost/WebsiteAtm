package ua.lviv.frost.configuration;
...
import ua.lviv.frost.configuration.interceptor.RequestLogInterceptor;
import ua.lviv.frost.controller.UserHandlerMethodArgumentController;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .ignoredParameterTypes(UserPrincipalCard.class)
                .select()
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder()
                .title("Frost-Server REST API")
                .description("")
                .contact(new Contact("Frost", "", "andriyko83701@gmail.com"))
                .license("Apache 2.0")
